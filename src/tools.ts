  ...
  return {
    ...
    getProcessDetails: tool({
      ...
      parameters: z.object({
        processId: z
          .string()
          .describe(
            "The processId or processName of the process to retrieve. Prefer using the processId returned by searchProcesses.",
          ),
      }),
    ...
    searchProcesses: tool({
      ...
      parameters: z.object({
        keywords: z
          .string()
          .describe(
            "Keywords to search for in process names, descriptions, and tags",
          ),
      }),
    ...
    askClarification: tool({
      ...
      parameters: z.object({
        ...
        options: z
          .array(z.string())
          .describe("Array of options for the user to choose from (max 2)"),
      }),
